...
$classMap = [
    ...
    "DataSourceFactory" => APP_DIR . "/services/DataSourceFactory.php",
    "FmpDataMapper" => APP_DIR . "/services/DataMapper/FmpDataMapper.php",
    "FileCacheService" => APP_DIR . "/services/Cache/FileCacheService.php",
    "FmpApiClient" => APP_DIR . "/models/FmpApiClient.php",
    "DataSourceInterface" => APP_DIR . "/models/Contracts/DataSourceInterface.php",
    ...
    "ShortcodeProvider" => APP_DIR . "/providers/ShortcodeProvider.php",
    "DataSourceProvider" => APP_DIR . "/providers/DataSourceProvider.php",
    "ReportGenerationOrchestrator" => APP_DIR . "/providers/ReportGenerationOrchestrator.php",
    "Router" => APP_DIR . "/controllers/Support/Router.php",
    "CsrfServiceInterface" => APP_DIR . "/services/Security/CsrfServiceInterface.php",
    "CsrfService" => APP_DIR . "/services/Security/CsrfService.php",
